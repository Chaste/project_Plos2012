...
\end{center}
\caption{
{\bf 3D off-lattice simulation coupled to PDE: A 3D simulation of a tumour spheroid, in which cell proliferation and death are dependent on the diffusion and uptake of oxygen within the spheroid}.
...
This figure displays the membrane voltage in a 2D 3cm $\times$ 3cm using the Luo-Rudy 1991 model \cite{Luo1991Model} with the modifications and protocol suggested in \cite{Qu2000Origins}.
}
...
\includegraphics[width=0.28\linewidth]{images/undeformed_cube.eps}
\includegraphics[width=0.28\linewidth]{images/deformed_cube.eps}
\end{center}
\caption{
{\bf Cardiac electromechanics in a ventricular wedge:} left, fibre orientation; middle and right, simulation of electrical propagation and deformation (middle: 10ms after stimulus on left face; right: 40ms after stimulus).
\highlight{Times need checking, still needs tidying up and a voltage colourbar.}
}
