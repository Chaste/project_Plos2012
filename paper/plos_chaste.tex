...
\includegraphics[width=0.8\linewidth]{images/MeshBasedSpheroidVtkAsPointsCrossSection.eps}
\end{center}
\caption{
...
\highlight{To do: run for longer than 100 h. 
See also MeshBasedSpheroidVtkAsPointsCrossSection.avi.}}
...
\url{https://chaste.cs.ox.ac.uk/cgi-bin/trac.cgi/wiki/InstallGuides/UbuntuPackage}.
...
\url{https://chaste.cs.ox.ac.uk/cgi-bin/trac.cgi/wiki/InstallGuides}
