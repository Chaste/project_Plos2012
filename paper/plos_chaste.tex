...
Simulations can be performed of single-cell ODE systems using CVODE, or at the tissue/whole-organ level using PDE formulations such as monodomain, bidomain, bidomain-with-bath, %\comment{[need ref here]}
and our new extended-bidomain system \cite{corrias2012modelling}.
