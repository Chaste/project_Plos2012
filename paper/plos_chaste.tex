...
Simple rules for the naming of variables, methods and classes enable developers to navigate their way through the code efficiently, and make mistakes less likely. 
In addition, using a standardised code layout and in-line documentation makes the code more readable.
...
(ii) Vertex dynamics models (2D, 3D planned in future). 
...
Elsewhere, the forces acting on each vertex are provided explicitly \cite{Weliky1990}.\highlight{Depending on when this paper is submitted, cite the Chaste vertex paper if it has been accepted!} 
...
We structure this section around four examples, which can all be reproduced by running the tests in the project which accompanies this paper.
...
You can also register to create a login for the Chaste wiki to view/comment on work tickets, and submit patches for inclusion in Chaste.
