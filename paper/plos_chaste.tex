...
Sara-Jane Dunn$^5$, Alexander G. Fletcher$^6$, Daniel G. Harvey$^{1}$, Megan E. Marsh$^{7}$, 
James M. Osborne$^{1}$, Pras Pathmanathan$^{1,8}$, Joe Pitt-Francis$^{1}$, 
James Southern$^9$, Nejib Zemzemi$^{10}$, David J. Gavaghan$^{1}$
\\
...
\\
\bf{7} Department of Computer Science, University of Saskatchewan, Saskatoon, Canada
\\
...
In Figure~\ref{fig:SpiralWave} we present a snapshot of a two-dimensional monodomain simulation which reproduces one of the results of a study into electrical wave dynamics \cite{Qu2000Origins} (see video S3).
...
Figure~\ref{fig:TwistyWedge} shows varying fibre directions throughout a three-dimensional block of tissue, alongside the spread of an electrical wave, and subsequent deformation (see also video S4).
