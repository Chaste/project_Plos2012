...
We have extensively used this component with off-lattice mesh-based models, \cite{VanLeeuwen2009,fletcher2012mathematical,Dunn2012}.
...
\begin{figure}[!ht]
\begin{center}
%\includegraphics[width=4in]{images/multi_crypts.eps}
\end{center}
\caption{
{\bf Four-crypts and villus simulation.}  
The code for this is available to download as supplementary material and can also be found at \texttt{http://chaste.here}. \garycomment{Possibly combine the delta-notch and 4 crypts and a villus simulation? Would get nice pattern of secretory / absorptive cells presumably, which they reckon is delta-notch.}
}
