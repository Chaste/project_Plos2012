...
On-lattice models which are supported include cellular automata (1--3D) \highlight{[ref]}, in which one lattice site is associated with one or more cells.
Advanced models of angiogenesis have been built using the cellular automata framework \cite{perfahl2011multiscale}.
Cellular Potts models are also available (1--3D), in which a cell occupies a number of lattice sites \highlight{[refs including CompuCell3d]}\cite{Graner1992Simulation}, and additional sites are included or removed to minimize an energy function.
...
In \cite{VanLeeuwen2009} we studied monoclonal conversion in the colorectal crypt and predicted neutral drift in the stem cell population,
which has since been proven experimentally \cite{lopez2010intestinal}.
We have extensively used these off-lattice mesh-based models to examine the concept and role of stem cells in crypt homeostasis \cite{fletcher2012mathematical,Dunn2012,Dunn2012Plos}.
