...
\begin{itemize}
 ...
 \item \texttt{continuum\_mechanics} --- code for compressible and incompressible linear and non-linear elasticity. \highlight{Pras again}.
\end{itemize}
...
The code for this is available to download as supplementary material and can also be found at \texttt{http://chaste.here}.
\highlight{Can we have three figures - fibre directions, electrical wave propogation at about half way (still mostly undeformed), and a fully deformed (depolarized) cube?}
}
