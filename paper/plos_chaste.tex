...
\includegraphics[width=0.4\linewidth]{images/multi_crypt_white_background.eps}
\end{center}
\caption{
{\bf 3D off-lattice simulation on a 2D surface: small intestinal crypts and villus}.  
\highlight{Mention lineage tracing. In another figure, consider combining Buske's delta-notch model with this simulation, to obtain a pattern of secretory/absorptive cells.}
}
